...
export const createComedianBlock = (comedians, bookingComediansList) => {
  ...
  const bookingTomSelectComedians = new TomSelect(bookingSelectComedian, {
    hideSelected: true,
  ...
  bookingTomSelectComedians.on('change', (id) => {
    bookingTomSelectTime.enable();
    bookingTomSelectComedians.blur();
  ...
  bookingTomSelectTime.on('change', (time) => {
    ...
    const idComedian = bookingTomSelectComedians.getValue();
